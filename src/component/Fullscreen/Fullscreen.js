...
export default function Fullscreen() {
  ...
  return (
    <div className={`dz-fullscreen fullscreen ${fullscreen?"full":""}`} onClick={() => {showfullscreen();}}>
      <svg className="fs-icon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100" xmlSpace="preserve">
