    ...
    <div className="overflow-y-auto overflow-x-hidden absolute bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] border-r-none border-b-none h-[95%] w-full top-0 rounded-[0] animate-[slidetop_0.5s_forwards] left-[-1px] pb-[125px] gap-15">
      {mydetail.length !== 0 && myproject.length !== 0 && myservice.length !== 0 && myskills.length !== 0 && mylanguages.length !== 0 ? (
        <>
          ...
          <div className="flex md:flex-row flex-col items-center md:m-[1vh_1vw] m-[12px_20px]">
            <div className="flex flex-col items-center m-auto gap-5 p-[10px] md:p-[1vw]">
              <div className="z-[200] rounded-[10px] md:rounded-[1vw] md:w-[28vw] w-[250px] md:h-[28vw] h-[250px] md:p-[0.5vw] p-[5px] m-auto bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] hoverdivbigsmall">
                <div className="rounded-[10px] md:rounded-[1vw] overflow-hidden h-[100%] w-[100%]">
                  <img src={`https://thekoushikdurgas.github.io/TKDstroage/img/tkd1.jpg`} alt="Koushik Chandra Saha" className='w-[100%] scale-110' />
                </div>
              </div>
              <div className="flex gap-5">
                <a className="hoverdivbigsmall text-[14px] md:text-[1.5vw] p-[10px] md:p-[1vh_1vw] font-semibold cursor-pointer outline-none rounded-[5px] md:rounded-[0.5vw] bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] flex items-center gap-1" href='https://koushikchandrasaha.thekoushikdurgas.in/private/Koushik%20Chandra%20Saha.pdf'><span>Download CV</span><i className="tkd11-server-download"></i></a>
                <Link className="hoverdivbigsmall text-[14px] md:text-[1.5vw] p-[10px] md:p-[1vh_1vw] font-semibold cursor-pointer outline-none rounded-[5px] md:rounded-[0.5vw] bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] flex items-center gap-1" to='/contact/'><span>Hire Me</span><i className="uil uil-message button_icon"></i></Link>
              </div>
            </div>
            <div className="md:m-[1vw] m-[0] rounded-[10px] md:rounded-[1vw] md:p-[1vh_1vw] p-[13px]  bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px]">
          ...
          {myservice.map((object, i) => (
            <div className="p-[3vh_2vw] cursor-pointer bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] rounded-[10px] md:rounded-[1vw] md:m-[1vh_1vw] m-[12px_20px]" key={i}>
              <div className="relative flex flex-col text-[#2c0101]">
                ...
                {myskills.filter((e) => e.type === object.name).map((object1, i1) => {
                  return (
                    <div key={i1}>
                      <div className="hoverdivbigsmall mb-[1vh] bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-b-none border-[#ffffff80] backdrop-blur-[5px] rounded-[5px] md:rounded-[0.5vw]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:m-[1vh_1vw] m-[12px_20px]">
            {mylanguages.map((t, i) => {
              return (
                <div className="hoverdivbigsmall bg-[#ffffff1a] shadow-[0_20px_50px_#00000026] border border-[#ffffff80] backdrop-blur-[5px] rounded-[10px] md:rounded-[1vw]" key={i}>
